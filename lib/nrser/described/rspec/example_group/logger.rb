...
module Logger
  ...
  def logger_description_named_tag
    ...
    when :message, :response_to
      RSpec::Format::Description.string_for metadata[ :message ]
    
    when :method
      ".#{ metadata[ :method_name ] }"
    
    when :sent_to
      RSpec::Format::Description.string_for metadata[ :receiver ]
  ...
  # metadata, specifically for the RSpec hierarchy created by nested 
  # {NRSER::RSpec::ExampleGroup::Describe} method calls.
  # 
  ...
  # 
  # @example
  #   MODULE NRSER::RSpec::ExampleGroup::Logger do
  #     logger.level = :debug
  #     
  ...
  #   #   MODULE  NRSER::RSpec::ExampleGroup::Logger
  #   # -- Here I am! -- {
  #   #     :key_1 => "value one",
  #   #     :key_2 => "value two"
  #   # }
